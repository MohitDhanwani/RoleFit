  ...
  return (
    <div>
      ...
      <div className="bg-slate-50 rounded-lg p-6 mt-10">
        ...
        <div className="flex gap-8">
          <div className="flex gap-3 border-2 border-slate-200 p-4 rounded-lg">
            <Checkbox id="yes-experience" className="w-6 h-6 border-slate-400 border-2" />
            <Label className="font-medium">Yes, I have Experience</Label>
          </div>
          <div className="flex gap-3 border-2 border-slate-200 p-4 rounded-lg">
            <Checkbox id="no-experience" className="w-6 h-6 border-slate-400 border-2" />
      ...
      <div className="mt-10">
        ...
        <Input placeholder="Eg 24" className="border border-slate-400"/>
      </div>
    </div>
  );
}
